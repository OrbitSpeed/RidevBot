Public Class User_Database
    ...
    Public Shared redirect_URI As String = "http://Ridevbot.oat:1000"
    Public Shared Parse_ID_URI As String = "&redirect_uri=http%3A%2F%2FRidevbot.oat%3A1000&response_type=code&scope="
