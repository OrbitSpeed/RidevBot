...
#End Region
    ...
    Private Sub Button_license_verify_Click(sender As Object, e As EventArgs) Handles Button_license_verify.Click
        ...
        Dim CurUser As New User_Database With
            {
            .GFH51DFGTK_1855577GH7_54SDQAVV = TextBox_license_username.Text,
                   .ATDS_K4H_TRT2MM2455784BB_TK2 = Utils.DateDistant,
                 .ATDGS_TK_PASSWORD185424175724557HSDJ1 = user_key
            }
    ...
    Private Sub Button_reg_Click(sender As Object, e As EventArgs) Handles Button_reg.Click
        ...
        Dim CurUser As New User_Database With
            {
            .GFH51DFGTK_1855577GH7_54SDQAVV = Utils.getSHA1Hash(TextBox_license_username.Text),
                        .ATDGS_TK_PASSWORD185424175724557HSDJ1 = Utils.getSHA1Hash(user_key),
          .ATDS_K4H_TRT2MM2455784BB_TK2 = Utils.getSHA1Hash(Utils.DateDistant.ToString)
                        }
