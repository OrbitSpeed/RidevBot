'WriteDMAInteger("Process", GetModuleHandle("Process", "Process.exe") + &HC48338, {&HF0, &H688, &H2E8, &H1C8, &H5D8}, 7, 5, 4)
'WriteInteger("Process", GetModuleHandle("Process", "Process.exe") + &H91CBE8, 1902616192)
'WriteLong("Process", &H10BA36CD, 1133823478)
