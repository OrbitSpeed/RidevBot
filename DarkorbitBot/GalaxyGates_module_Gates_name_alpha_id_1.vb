...
Public Class GalaxyGates_module_Gates_name_alpha_id_1
    Public Shared WebClient_POST_1 As New System.Net.WebClient
    Public Shared Table_Load_1 As String = """.*) \/>"
    Public Shared Verification_1 As String = 0
    Public Shared Npc_current_1 As String

    Public Shared Function Load(ByVal Verification)

        If Verification = 1 Then
            WebClient_POST_1.Headers.Add(HttpRequestHeader.Cookie, $"dosid={Utils.dosid};") 'POST / GET socket Information
            Dim WebClient_Data = WebClient_POST_1.DownloadString("https://" + Utils.server + ".darkorbit.com/flashinput/galaxyGates.php?userID=" + Utils.userid + "&action=init&sid=" + Utils.dosid)
            Dim WebClient_GET_All_elements_Alpha = Regex.Match(WebClient_Data, "<gate (.*id=""1" + Table_Load_1).Groups.Item(1).ToString 'A
            Console.WriteLine(WebClient_GET_All_elements_Alpha)

            If WebClient_GET_All_elements_Alpha.Contains("prepared=""1""") Then
